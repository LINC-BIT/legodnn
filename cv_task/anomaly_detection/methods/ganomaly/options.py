...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataroot', default=os.path.join(this_dir_path, '../../datasets'), help='path to dataset')
        ...
        self.parser.add_argument('--best_auc_g_save_path', type=str)
        self.parser.add_argument('--best_auprc_g_save_path', type=str)
        self.parser.add_argument('--best_f1_g_save_path', type=str)

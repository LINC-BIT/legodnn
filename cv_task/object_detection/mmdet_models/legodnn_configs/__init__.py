...
def get_retinanet_free_anchor_r50_fpn_1x_b16_voc2007_config(mode='train'):
    assert mode in ['train', 'fn3', 'usnet', 'fine_tune', 'nestdnn', 'usnet_bn_cal']
    if mode=='train':
        cfg = Config.fromfile(root_path + 'retinanet_free_anchor_r50_fpn_1x_b16_voc2007.py')
    elif mode=='fn3':
        cfg = Config.fromfile(root_path + 'retinanet_free_anchor_r50_fpn_1x_b16_voc2007_fn3.py')
    elif mode=='usnet':
        cfg = Config.fromfile(root_path + 'retinanet_free_anchor_r50_fpn_1x_b16_voc2007_usnet.py')
    elif mode=='usnet_bn_cal':
        cfg = Config.fromfile(root_path + 'retinanet_free_anchor_r50_fpn_1x_b16_voc2007_usnet_bn_cal.py')
    elif mode=='nestdnn':
        cfg = Config.fromfile(root_path + 'retinanet_free_anchor_r50_fpn_1x_b16_voc2007_nestdnn.py')
    elif mode=='fine_tune':
        cfg = Config.fromfile(root_path + 'retinanet_free_anchor_r50_fpn_1x_b16_voc2007_fine_tune.py')
    else:
        raise NotImplementedError
    return cfg

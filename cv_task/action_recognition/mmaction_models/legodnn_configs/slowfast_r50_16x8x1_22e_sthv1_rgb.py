_base_ = [
    '../configs/_base_/models/slowfast_r50.py', 
...
data_root = '/data/datasets/sthv1/rawframes'
data_root_val = '/data/datasets/sthv1/rawframes'
ann_file_train = '/data/datasets/sthv1/sthv1_train_list_rawframes.txt'
ann_file_val = '/data/datasets/sthv1/sthv1_val_list_rawframes.txt'
ann_file_test = '/data/datasets/sthv1/sthv1_val_list_rawframes.txt'

...
data_root = '/data/datasets/sthv2/rawframes'
data_root_val = '/data/datasets/sthv2/rawframes'
ann_file_train = '/data/datasets/sthv2/sthv2_train_list_rawframes.txt'
ann_file_val = '/data/datasets/sthv2/sthv2_val_list_rawframes.txt'
ann_file_test = '/data/datasets/sthv2/sthv2_val_list_rawframes.txt'

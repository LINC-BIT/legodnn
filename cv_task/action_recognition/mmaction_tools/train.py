...
def train_recognizer_by_config(recognizer, cfg):
    args = parse_args()
...
if __name__ == '__main__':
    ...
    cfg = get_tsn_r50_1x1x8_50e_hmdb51_imagenet_rgb_config()
    recognizer = build_model(cfg.model, train_cfg=cfg.get('train_cfg'), test_cfg=cfg.get('test_cfg'))
    train_recognizer_by_config(recognizer, cfg)

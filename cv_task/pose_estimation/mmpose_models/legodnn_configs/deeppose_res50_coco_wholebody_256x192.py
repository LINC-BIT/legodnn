_base_ = ['../configs/_base_/datasets/coco_wholebody.py']
...
work_dir = './deeppose_res50_coco_wholebody_256x192'
...
data_cfg = dict(
    ...
    use_gt_bbox=False,
    det_bbox_thr=0.0,
    bbox_file='/data/datasets/coco2017/person_detection_results/'
...
legodnn_train_pipeline = val_pipeline

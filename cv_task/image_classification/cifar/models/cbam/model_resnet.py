...
from cv_task.image_classification.cifar.models.cbam.cbam import *
from cv_task.image_classification.cifar.models.cbam.bam import *
...
def cbam_resnet18(num_classes=10):
    ...
    if num_classes==10:
        return ResidualNet("CIFAR10", 18, num_classes, 'CBAM')
    else:
        return ResidualNet("CIFAR100", 18, num_classes, 'CBAM')
...
def save_model_to_onnx():
    ...
    onnx_path = '/data/gxy/legodnn-public-version_9.27/cv_task/image_classification/cifar/onnx_model_weight/cifar10_cbam_resnet18.onnx'

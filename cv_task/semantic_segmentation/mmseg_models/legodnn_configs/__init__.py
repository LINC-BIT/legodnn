...
def get_deeplabv3_r18_d8_512x512_b16_30k_voc2012_config(mode='train'):
    assert mode in ['train', 'fine_tune', 'usnet', 'fn3', 'cgnet', 'nestdnn', 'test', 'test_nestdnn']
    if mode in ['train', 'cgnet']:
        cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012.py')
    elif mode == 'usnet':
        cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012_usnet.py')
    elif mode == 'fn3':
        cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012_fn3.py')
    elif mode=='fine_tune':
        cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012_fine_tune.py')
    elif mode=='nestdnn':
        cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012_nestdnn.py')
    # elif mode=='test':
    #     cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012_test.py')
    # elif mode=='test_nestdnn':
    #     cfg = Config.fromfile(root_path + 'deeplabv3_r18-d8_512x512_b16_30k_voc2012_test_nestdnn.py')
    else:
        raise NotImplementedError
    return cfg

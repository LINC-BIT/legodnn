...
from cv_task.semantic_segmentation.mmseg_models.legodnn_configs import get_gcnet_r50_d8_512x1024_40k_cityscapes_config

pretrained_root_path = '/data/gxy/pretrained_models/mmsegmentation/'

def gcnet_r50_d8(config, mode='lego_jit', device='cuda'):
    assert mode in LOAD_MODE
    checkpoint = os.path.join(pretrained_root_path, 'gcnet_r50-d8_512x1024_40k_cityscapes_20200618_074436-4b0fd17b.pth')
    if mode=='lego_jit':
...
if __name__=='__main__':
    model_config = get_gcnet_r50_d8_512x1024_40k_cityscapes_config((1,3,320,320))
    model = gcnet_r50_d8(model_config)

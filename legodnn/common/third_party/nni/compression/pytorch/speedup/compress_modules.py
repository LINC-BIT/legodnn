...
replace_module = {
    ...
    'ConvTranspose2d': lambda module, mask: replace_conv2dt(module, mask),
    ...
    'EltwiseAdd': lambda module, mask: no_replace(module, mask),
    'TwoAdd': lambda module, mask: no_replace(module, mask),
    
    # yolov3
    'ZeroPad2d': lambda module, mask: no_replace(module, mask),
    
    'Tanh': lambda module, mask: no_replace(module, mask)
}
...
def replace_conv2dt(convtrans, mask):
    """
    ...
    # print('convtrans {} {} {}'.format(in_channels, out_channels, groups))

...
import logging
from schema import And, Or, Optional, SchemaError
from .....common.graph_utils import TorchModuleGraph
from .....compression.pytorch.utils.shape_dependency import ChannelDependency, GroupDependency
from .constants import MASKER_DICT
from .....compression.pytorch.utils.config_validation import CompressorSchema
from .....compression.pytorch.compressor import Pruner
...
__all__ = ['LevelPruner', 'SlimPruner', 'L1FilterPruner', 'L2FilterPruner', 'FPGMPruner',
           ...
           'TRRFilterPruner', 'HRankFilterPruner', 'PFPPruner']
...
class TRRFilterPruner(_StructuredFilterPruner):
    def __init__(self, model, config_list, optimizer=None, dependency_aware=False, train_loader=None, device='cuda'):
        super().__init__(model, config_list, pruning_algorithm='trr', optimizer=optimizer,
                         dependency_aware=dependency_aware, train_loader=train_loader, device=device)
...
class HRankFilterPruner(_StructuredFilterPruner):
    def __init__(self, model, config_list, optimizer=None, activation='relu',
                 statistics_batch_num=1, dependency_aware=False, dummy_input=None):
        super().__init__(model, config_list, pruning_algorithm='hrank', optimizer=optimizer,
                         dependency_aware=dependency_aware, dummy_input=dummy_input,
                         activation=activation, statistics_batch_num=statistics_batch_num)
        
        
# implemented by queyu, 2021/6/10
class PFPPruner(_StructuredFilterPruner):
    def __init__(self, model, config_list, optimizer=None, activation='relu',
                 statistics_batch_num=1, dependency_aware=False, dummy_input=None):
        super().__init__(model, config_list, pruning_algorithm='pfp', optimizer=optimizer,
                         dependency_aware=dependency_aware, dummy_input=dummy_input,
                         activation=activation, statistics_batch_num=statistics_batch_num)

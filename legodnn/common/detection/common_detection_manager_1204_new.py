...
from legodnn.common.detection.base_block_detection_1204_new import BaseBlockDetection
from legodnn.common.detection.model_topology_extraction import LegoDNNGraph

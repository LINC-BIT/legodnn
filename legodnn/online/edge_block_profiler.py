...
from legodnn.common.manager import AbstractBlockManager,AbstractModelManager
from legodnn.common.utils import logger,ensure_dir,read_yaml



class EdgeBlockProfiler:
    ...
    def profile_original_blocks(self):
        ...
        for i, block_id in enumerate(blocks_id):
            ...
            raw_block_latency = self._block_manager.get_block_latency(raw_block, self._test_sample_num, 
                                                                      block_input_size, self._device)
    ...
    def profile_all_compressed_blocks(self):
        ...
        for block_index in range(blocks_num):
            ...
            cur_raw_block_latency = self._block_manager.get_block_latency(cur_raw_block, self._test_sample_num, 
                                                                          cur_block_input_size, self._device)
            ...
            for sparsity in self._block_manager.get_blocks_sparsity()[block_index]:
                ...
                cur_block_latency = self._block_manager.get_block_latency(cur_block, self._test_sample_num, 
                                                                          cur_block_input_size, self._device)

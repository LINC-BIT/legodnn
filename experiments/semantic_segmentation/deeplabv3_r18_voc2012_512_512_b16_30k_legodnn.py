...
from cv_task.datasets.semantic_segmentation import mmseg_voc2012_dataloader
from cv_task.semantic_segmentation.mmseg_models.legodnn_configs import get_deeplabv3_r18_d8_512x512_b16_30k_voc2012_config
from cv_task.semantic_segmentation.mmseg_tools import mmseg_init_model

if __name__=='__main__':
    cv_task = 'semantic_segmentation'
    dataset_name = 'voc2012'
    model_name = 'deeplabv3_r18_d8_512_512_b16'
    device = 'cuda'
    ...
    test_sample_num = 100
    model_config = get_deeplabv3_r18_d8_512x512_b16_30k_voc2012_config('train')
    ...
    train_loader, test_loader = mmseg_voc2012_dataloader(cfg=model_config)

...
from cv_task.datasets.anomaly_detection.ornet_ucsd_ped1 import ornet_ucsd_ped1_dataloader
from cv_task.anomaly_detection.models.ornet import ornet_resnet18_ucsd_ped1
...
if __name__ == '__main__':
    ...
    teacher_model = ornet_resnet18_ucsd_ped1(pretrained=False, device=device)
    # exit()
    ...
    train_loader, test_loader, all_video_frames_label = ornet_ucsd_ped1_dataloader()
    model_manager = CommonAnomalyDetectionModelManager(model_name=model_name, all_video_frames_label=all_video_frames_label)

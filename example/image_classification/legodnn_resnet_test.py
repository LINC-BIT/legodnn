...
import sys
sys.path.insert(0, '../../')
sys.path.insert(0,"/data/gxy/legodnn-auto-on-cv-models-lyx/")
...
if __name__ == '__main__':
    ...
    teacher_model.load_state_dict(torch.load('cv_task_model/image_classification/cifar100/resnet18/2021-10-20/22-09-22/resnet18.pth')['net'])

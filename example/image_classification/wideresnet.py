...
from cv_task.image_classification.cifar.models import wideresnet_40_10

if __name__ == '__main__':
    cv_task = 'image_classification'
    dataset_name = 'cifar100'
    model_name = 'wideresnet_40_10'
    ...
    teacher_model = wideresnet_40_10(num_classes=100).to(device)
